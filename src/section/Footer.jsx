const Footer = () => {
    ...
    return (
        <footer className="c-space pt-7 pb-8 flex justify-between items-center flex-wrap gap-5 bg-gradient-to-r from-violet-700 to-violet-800 dark:from-violet-900 dark:to-black transition-colors">
            ...
            <p className="text-white-600">&copy;{year} Ryo khrisna fitriawan. All rights reserved.</p>
        </footer>
    );
};
