export const translations = {
    en: {
        ...
        contact: {
            title: "Let's talk",
            subtitle: "whether you have a question or just want to say hi, my inbox is open for all.",
            fullName: "full name",
    ...
    id: {
        ...
        reviews: {
            title: "Ulasan Klien",
            subtitle: "Apa kata klien saya tentang bekerja dengan saya",
        },

        // Contact Section
        contact: {
            title: "Mari berbicara",
            subtitle: "apakah Anda memiliki pertanyaan atau hanya ingin menyapa, inbox saya terbuka untuk semua.",
            fullName: "nama lengkap",
            namePlaceholder: "siapa nama Anda?",
            email: "email",
            emailPlaceholder: "apa email Anda?",
            message: "pesan Anda",
            messagePlaceholder: "apa yang ingin Anda sampaikan?",
            sending: "Mengirim...",
            sendMessage: "Kirim Pesan",
            successMessage: "Terima kasih! Saya akan menghubungi Anda sesegera mungkin.",
